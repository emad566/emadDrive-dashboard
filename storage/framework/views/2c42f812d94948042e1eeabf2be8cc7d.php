...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.input','data' => ['wire:model.live' => 'permission_search','name' => 'permission_search','label' => __('Permissions'),'placeholder' =>  __('Permissions') . ' ... ' . __('Search') . ' ... ' ,'wrapperClasses' => 'col-12']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'permission_search','name' => 'permission_search','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Permissions')),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute( __('Permissions') . ' ... ' . __('Search') . ' ... ' ),'wrapperClasses' => 'col-12']); ?>
...
<div class="row">
    ...
    <!-- __BLOCK__ --><?php if($errors->first('selectedPermissionIds')): ?> <span class="form-text text-danger"><?php echo e($errors->first('selectedPermissionIds')); ?></span> <?php endif; ?> <!-- __ENDBLOCK__ -->
