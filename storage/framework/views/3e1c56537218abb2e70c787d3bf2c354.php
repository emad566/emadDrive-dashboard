<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" >
        <ul class="menu-nav">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item <?php echo e((request()->is('dashboard/accounts/user*')) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                        <a wire:navigate href="<?php echo e(route('users.index')); ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                    ...
                                    <li class="menu-item <?php echo e((request()->is('dashboard/accounts/users/roles*')) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                        <a wire:navigate href="<?php echo e(route('roles.index')); ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                    ...
                                    <li class="menu-item <?php echo e((request()->is('dashboard/accounts/users/permission*')) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                        <a wire:navigate href="<?php echo e(route('permissions.index')); ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item <?php echo e((request()->is('dashboard/accounts/captains')) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                        <a wire:navigate href="<?php echo e(route('captains.index')); ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item <?php echo e((request()->is('dashboard/accounts/passengers*')) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                        <a wire:navigate href="<?php echo e(route('passengers.index')); ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
            ...
            <!-- vehicles -->
            <li class="menu-item menu-item-submenu <?php echo e(request()->is('dashboard/vehicles*') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
                <a href="javascript:;" class="menu-link menu-toggle">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                        <i class="fa fas fa-car text-primary icon-lg"></i>
                    </span>
                    <span class="menu-text"><?php echo e(__('Vehicles')); ?></span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="menu-submenu">
                    <i class="menu-arrow"></i>
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item <?php echo e((request()->is('dashboard/*')) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                            <a wire:navigate href="<?php echo e(route('vehicles.index')); ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <i class="fa fas fa-car text-primary icon-md"></i>
                                            </span>
                                <span class="menu-text"><?php echo e(__('Vehicle Class')); ?></span>
                            </a>
                        </li>
                        <li class="menu-item <?php echo e((request()->is('dashboard/vehicles/properties*')) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                            <a wire:navigate href="<?php echo e(route('properties.index')); ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <i class="fa fas fa-universal-access text-primary icon-md"></i>
                                            </span>
                                <span class="menu-text"><?php echo e(__('Properties')); ?></span>
                            </a>
                        </li>
                    </ul>
                </div>
...
<?php /**PATH D:\wamp64\www\atmo-ndash\resources\views/components/layouts/partials/_aside.blade.php ENDPATH**/ ?>